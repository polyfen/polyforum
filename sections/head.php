<head>
  ...
  */
  ...
  <script async src="https://www.googletagmanager.com/gtag/js?id=UA-151202895-3"></script>
  <script>
    window.dataLayer = window.dataLayer || [];
    function gtag(){dataLayer.push(arguments);}
    gtag('js', new Date());

    gtag('config', 'UA-151202895-3');
  </script>

  <!-- Hotjar Tracking Code for https://polyforum.org -->
  <script>
      (function(h,o,t,j,a,r){
          h.hj=h.hj||function(){(h.hj.q=h.hj.q||[]).push(arguments)};
          h._hjSettings={hjid:2350657,hjsv:6};
